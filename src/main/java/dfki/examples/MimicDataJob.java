...
public class MimicDataJob {
    public static void main(String[] args) throws Exception {
        ...
        FlinkKafkaProducer<KeyedDataPoint<Double>> MimicDataKafkaProducer = new FlinkKafkaProducer<>(
        ...
        DataStream<KeyedDataPoint<Double>> mimicData = env.addSource(new MimicDataSourceFunction(mimicFile))
                .assignTimestampsAndWatermarks(new UserDefinedFunctions.ExtractTimestampKeyedDataPoint());
        ...
        DataStream<KeyedDataPoint<Double>> mimicDataSmoothNormalized = mimicDataSmooth
                ...
                .keyBy("key")
                .map(new UserDefinedFunctions.ZscoreNormalization());
