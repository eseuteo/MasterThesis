...
class Average extends AggregateFunction[DataPoint[Double], (Long, String, Double, Int), (Long, String, Double)] {
  ...
  override def getResult(acc: (Long, String, Double, Int)): (Long, String, Double) = (acc._1, acc._2, acc._3 / acc._4)
